...
import { EVOLUTION_ENUM, FROG_ELEMENT_ENUM, FROG_POWERUP_ENUM, FrogItem, POND_ENUM, PondItem } from 'src/models/items';
...
export const evolve_frog = createAction('[Frog] Evolve', props<{ frogId: string, evolution: EVOLUTION_ENUM, newElement: FROG_ELEMENT_ENUM  }>());
